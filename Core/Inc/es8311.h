 ...
 *
 * Ported to STM32 HAL I2C for the Clion_h7_01 project.
 */
...
/* STM32 HAL I2C handle (forward declaration keeps the driver decoupled) */
...
/* Ported return codes (0 = success, negative = error) */
#define ES8311_OK              0
#define ES8311_ERR_INVALID_ARG (-1)
#define ES8311_ERR_I2C         (-2)
 ...
 * @return
 *     - ES8311_OK success
 *     - ES8311_ERR_INVALID_ARG Sample frequency or resolution invalid
 *     - Else fail
 */
int32_t es8311_init(es8311_handle_t dev, const es8311_clock_config_t *const clk_cfg, const es8311_resolution_t res_in,
 ...
 *     - Else fail
 */
int32_t es8311_voice_mute(es8311_handle_t dev, bool enable);
 ...
 * @return
 *     - ES8311_OK success
 *     - ES8311_ERR_INVALID_ARG cannot set clock dividers for given MCLK and sampling frequency
 ...
 *
 * @param[in] hi2c     STM32 I2C handle the chip is on (e.g. &hi2c2)
 * @param[in] dev_addr I2C device address of ES8311 (7-bit, e.g. ES8311_ADDRRES_0)
 *
 * @return
 *     - NULL Fail
 *     - Others Success
